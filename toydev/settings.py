"""
Django settings for toydev project.
...
SECRET_KEY = 'django-insecure-p1wsvp+1saaeji8(^z0qvtcjf8=#rx$(-=^e$2qq7bc1demp@3'
...
WSGI_APPLICATION = 'toydev.wsgi.application'
